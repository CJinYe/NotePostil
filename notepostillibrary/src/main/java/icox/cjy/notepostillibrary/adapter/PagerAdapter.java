...
import icox.cjy.notepostillibrary.utils.ScreenCaptrueUtil;
...
public class PagerAdapter extends FragmentStatePagerAdapter {
    ...
    public File saveBitmap(String content, int i) {
        ...
        if (null != tuyaBean && tuyaBean.bitmapPath != null) {
            Bitmap bitmap1 = createBitmap(tuyaBean.bitmapPath.getPath());
            ...
            Bitmap bitmap1 = createBitmap(mDesFiles[i].getPath());
            if (bitmap1 != null) {
                canvas = new Canvas(bitmap);
                canvas.drawBitmap(bitmap1, 0, 0, null);
            } else {
