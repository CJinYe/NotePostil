...
import icox.cjy.notepostillibrary.views.ProgressTextView;
import icox.cjy.notepostillibrary.views.SnailBar;
...
public abstract class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initColorPickerDialogView(this);
    }

    protected abstract void initColorPickerDialogView(ColorPickerDialog colorPickerDialog);
    ...
    private void initView() {
        ...
        mSeekBar = (SnailBar) findViewById(R.id.dialog_color_picker_seek_bar);
