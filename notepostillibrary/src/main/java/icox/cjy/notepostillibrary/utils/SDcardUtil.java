...
public class SDcardUtil {
    ...
    public static String getSavaPath() throws Exception {
        ...
        if (SDcardUtil.ExistSDCard()) {
            sdPath = Environment.getExternalStorageDirectory()
                    + "/点读笔记批注/" + Constants.BOOK_NAME + "/" + Constants.BOOK_LOCATION;
    ...
    public static File getPostilSavaPath() throws Exception {
        String sdPath = null;
        File file = null;
        if (SDcardUtil.ExistSDCard()) {
            sdPath = Environment.getExternalStorageDirectory()
                    + "/点读笔记批注/" + Constants.BOOK_NAME + "/" + Constants.BOOK_LOCATION + "/" + Constants.POSTIL;
    ...
    public static String getSavaPath(String bookName, String bookLocation) throws Exception {
        String sdPath = null;
        if (SDcardUtil.ExistSDCard()) {
            sdPath = Environment.getExternalStorageDirectory()
                    + "/点读笔记批注/" + bookName + "/" + bookLocation;
